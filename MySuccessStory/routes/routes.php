...
#region CRUD Notes
SimpleRouter::get('/api/notes', [ControllerNotes::class, 'read']); // read a single note
SimpleRouter::post('/api/notes', [ControllerNotes::class, 'create']); // add a new note to the database
SimpleRouter::patch('/api/notes', [ControllerNotes::class, 'update'], ["defaultParameterRegex" => "[\w\-\.]+"]); // change the value of a note
SimpleRouter::delete('/api/notes', [ControllerNotes::class, 'delete']); // delete a note
#endregion
