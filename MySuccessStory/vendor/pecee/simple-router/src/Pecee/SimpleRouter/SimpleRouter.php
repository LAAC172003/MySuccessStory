...
class SimpleRouter
{
    ...
    /**
     * This route will route request from the given url to the controllers.
     *
     * @param string $url
    ...
    /**
     * This type will route all REST-supported requests to different methods in the provided controllers.
     *
     * @param string $url
     * @param string $controller
     * @param array|null $settings
